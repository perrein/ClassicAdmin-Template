...
var banner = ['/*!\n',
    ' * ClassAdmin - <%= pkg.title %> v<%= pkg.version %> (<%= pkg.homepage %>)\n',
...
gulp.task('sass', function() {
    return gulp.src('scss/sb-admin-2.scss')
        .pipe(sass())
...
gulp.task('copy', function() {
    ...
    gulp.src(['bower_components/bootstrap-social/*.css', 'bower_components/bootstrap-social/*.scss'])
    ...
    gulp.src(['bower_components/popper.js/dist/umd/popper.js', 'bower_components/popper.js/dist/umd/popper.min.js'])
